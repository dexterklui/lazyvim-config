-- Automatically add `""` when typing `=` at appropriate place
...
-- TODO: Automatically close self-closing tag
-- Link: https://medium.com/scoro-engineering/5-smart-mini-snippets-for-making-text-editing-more-fun-in-neovim-b55ffb96325a
--
-- vim.keymap.set("i", "/", function()
